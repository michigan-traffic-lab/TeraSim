...
for i in {1..1000}; do
    ...
    # test record
    python safetest_mcity_main_AV.py --dir ${DIR_NAME} --name ${experiment_name} --nth ${exp_nth} --aggregateddir ${DIR_NAME}/${experiment_name}/aggregated_data/${SLURM_ARRAY_TASK_ID} > ${DIR_NAME}/${experiment_name}/raw_data/${exp_nth}/res.txt
